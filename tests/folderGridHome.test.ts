...
test('mantener presionada una carpeta conserva drag real y la suelta termina el modo automáticamente', () => {
  ...
  assert.doesNotMatch(interactiveCss, /oanix-folder-jiggle/)
  assert.match(interactiveCss, /\.oanix-folder-grid--reordering \.oanix-folder-rail__item\[data-oanix-folder-id\][\s\S]*outline:/)
