...
test('the host delegates concrete selection to the editor surface registry and mounts it lazily', () => {
  ...
  assert.match(host, /OanixTextLineRuntimeProvider/)
  assert.match(host, /flushOanixTextLineEditors/)
  assert.doesNotMatch(host, /installOanixTextBehaviorBridge|behaviorRevision/)
