...
test('organic tag reorder arrows remain visible without perpetual idle animation', () => {
  ...
  assert.match(workspace, /\.oanix-organic-tags__arrows[\s\S]*animation:\s*oanix-organic-arrows[^;]*;/)
  ...
  assert.doesNotMatch(guard, /html\.oanix-v383-visual\s+\.oanix-organic-tags__arrows/)
