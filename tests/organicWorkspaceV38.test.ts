...
test('folders, tags and notes finish reordering automatically after release', () => {
  ...
  assert.match(noteGesture, /document\.addEventListener\('touchend', finishDrag/)
  ...
  assert.doesNotMatch(noteGesture, /setPointerCapture|pointermove|PRESS_ARM_GRACE_MS|finishAutomaticMode|dispatchDragStart|new PointerEvent/)
