...
public class OanixDocumentsPlugin extends Plugin {
    ...
    public void beginSaveBackup(PluginCall call) {
        ...
        if (
            ...
            call.reject("El nombre del backup no es válido.");
            return;
        }
        ...
        try {
            startActivityForResult(call, intent, "createBackupResult");
        } catch (Exception error) {
            call.reject("No se pudo abrir el selector para guardar el backup.", error);
        }
    }
    ...
    private void createBackupResult(PluginCall call, ActivityResult result) {
        ...
        try {
            ...
            call.reject("No se pudo preparar el archivo de backup seleccionado.", error);
        }
    }
    ...
    public void finishSaveBackup(PluginCall call) {
        ...
        try {
            ...
            closeActiveWrite(true);
            call.reject("No se pudo finalizar el backup en Android.", error);
        }
    }
