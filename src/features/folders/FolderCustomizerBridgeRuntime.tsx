...
export function FolderCustomizerBridgeRuntime() {
  useEffect(() => {
    const interceptFolderGear = (event: Event) => {
    ...
    document.addEventListener('pointerdown', interceptFolderGear, true)
    document.addEventListener('click', interceptFolderGear, true)

    return () => {
      document.removeEventListener('pointerdown', interceptFolderGear, true)
      document.removeEventListener('click', interceptFolderGear, true)
    }
  }, [])
