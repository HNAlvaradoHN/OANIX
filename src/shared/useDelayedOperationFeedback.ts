...
/**
 * Avoids flashing progress UI for fast work while guaranteeing that a process
 * which remains perceptible tells the user that OANIX is still doing something.
 * The caller owns the actual stage/progress text; this hook only owns timing.
 */
